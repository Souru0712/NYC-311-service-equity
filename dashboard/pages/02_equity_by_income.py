...
st.caption(
    ...
    "Note: **UNSPECIFIED** represents complaints whose coordinates did not match a census tract "
    "in the spatial join — typically because the Census API tract boundaries are not fully "
    "up to date with newly developed or reclassified areas. These records have no assignable "
    "borough and their P90 pattern does not reflect any single agency or service category."
)
st.info(
